...
class AttentionHead(nn.Module):
    def __init__(self, hid):
        ...
        self.fc_payment = nn.Sequential(nn.Linear(hid, 1), nn.Sigmoid()) #CHANGED
    ...
    def forward(self, x):
        ...
        alloc = F.softmax(logits, 1)  # [-1, num_agents, num_items] #CHANGED
        
        pay = 1/self.fc_payment(x_agent).squeeze(-1)  # [-1, num_agents]
        #scale alloc to one
        return alloc, pay
